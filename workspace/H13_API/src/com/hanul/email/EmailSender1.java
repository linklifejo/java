...
public class EmailSender1 {
	...
	//	SimpleEmail mail = new SimpleEmail();
		...
		try {
			...
			file.setPath("list.txt");
			mail.attach(file);
			file.setURL(new URL("https://stock.adobe.com/kr/search?filters%5Bcontent_type%3Aphoto%5D=1&filters%5Bcontent_type%3Aillustration%5D=0&filters%5Bcontent_type%3Azip_vector%5D=0&filters%5Bcontent_type%3Avideo%5D=0&filters%5Bcontent_type%3Atemplate%5D=0&filters%5Bcontent_type%3A3d%5D=0&filters%5Bcontent_type%3Aaudio%5D=0&filters%5Bcontent_type%3Aimage%5D=1&filters%5Binclude_stock_enterprise%5D=0&filters%5Bis_editorial%5D=0&k=arrow&order=relevance&safe_search=1&limit=100&search_type=filter-select&search_page=1&get_facets=1"));
			mail.attach(file);
			mail.send();
		} catch (Exception e) {
			// TODO: handle exception
